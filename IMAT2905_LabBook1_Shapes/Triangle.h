...
private:
	...
	*/
	...
	float NumberOfPoints = { 3.0f };//This is what the circle is divisible by.
...
public:
	Triangle();
	Triangle(int xPosition, int yPosition, int radiusXPosition, int radiusYPosition);	//Overload Constructor with valus passed for X and Y positions, and raduis X and Y positions
	void createTriangle();																// A create function has been added, for code clarity and easier readability
